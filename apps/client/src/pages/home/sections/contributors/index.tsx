...
import { Avatar, AvatarFallback, AvatarImage, Tooltip } from "@elevate/ui";
    ...
    <section id="contributors" className="container relative space-y-12 py-24 sm:py-32">
      <div className="space-y-6 text-center">
        ...
        <p className="mx-auto max-w-3xl leading-loose">
          {t`Elevate thrives thanks to its vibrant community. This project owes its progress to numerous individuals who've dedicated their time and skills. Below, we celebrate the coders who've enhanced its features and the linguists whose translations have made it accessible to a broader audience.`}
        </p>
      </div>
